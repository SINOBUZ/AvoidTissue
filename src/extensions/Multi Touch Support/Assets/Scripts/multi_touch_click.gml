...
//third touch
if device_mouse_check_button_pressed(2,mb_left) = true
    {
...
//fourth touch
if device_mouse_check_button_pressed(3,mb_left) = true
    {
...
//fifth touch
if device_mouse_check_button_pressed(4,mb_left) = true
    {
